// const pokemons = pokemons.slice(0,30)   
var ellist = document.querySelector(".site-main__list");



function pakemo(array,elsearchvalue) {
    ellist.innerHTML = "";
...
const SortBtnAz = document.querySelector(".site-header__sort--a-z");
const SortBtnZa = document.querySelector(".site-header__sort--z-a");
const btnWrapper = document.querySelector(".site-header__btnwrapper")
